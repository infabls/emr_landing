  ...
  <div class="parallax parallax3 customers lazyload" data-bg="style/images/1pt.jpg">
    <div class="container inner text-center">
      <div class="testimonials">
        <div class="item">
          <blockquote>
            <p>ECOMARKER YELIMAY – маркер добросовестности предприятия по надлежащей утилизации всех видов опасных отходов.</p>
            <p>Компания, присоединившаяся к проекту, подтверждает свое твердое намерение сформировать безопасную и благоприятную для жизни и здоровья работников и проживающих рядом с производством людей зону.</p>
            <p>ECOMARKER YELIMAY даст мощный импульс для расширения безопасной среды.</p> 
            <p>ECOMARKER YELIMAY – сигнал для всех тех, кому не безразлично в какой стране будут жить наши дети и внуки!</p>
          </blockquote>
        </div>
      </div>
    </div>
