          ...
          <ul class="content-slider items isotope">
            <li class="item thumb web isotope-item" >
              <figure><a target="_blank" href="https://qwmo.net" >
                ...
                <img src="/style/images/new/partner/1.jpg" alt="ТОО «Казахстанский оператор по управлению отходами»"> </a></figure>
            </li>
            <li class="item thumb graphic isotope-item">
              <figure><a target="_blank" href="https://promothod.kz" >
                ...
                <img src="/style/images/new/partner/2.jpg" alt="ТОО «ПРОМОТХОД КАЗАХСТАН»"> </a></figure>
            </li>
            <li class="item thumb web isotope-item">
              <figure><a  href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/3.jpg" alt="ТОО «Промышленные отходы»"> </a></figure>
            </li>
            <li class="item thumb web isotope-item">
              <figure><a target="_blank" href="https://trrr.kz">
                ...
                <img src="/style/images/new/partner/4.jpg" alt="RRR technology"> </a></figure>
            </li>
            <li class="item thumb photo isotope-item">
              <figure><a target="_blank" href="https://empls.biz">
                ...
                <img src="/style/images/new/partner/5.jpg" alt=""> </a></figure>
            </li>
            <li class="item thumb motion isotope-item">
              <figure><a target="_blank" href="https://kzsr.kz">
                ...
                <img src="/style/images/new/partner/6.jpg" alt="ТОО «КазВторРесурс»"> </a></figure>
            </li>
            <li class="item thumb photo isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/7.jpg" alt="ТОО «Smart Waste»"> </a></figure>
            </li>
            <li class="item thumb web isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/15.jpg" alt="Статус Караганда"> </a></figure>
            </li>
            <li class="item thumb graphic isotope-item">
              <figure><a target="_blank" href="https://rpo.kz" >
                ...
                <img src="/style/images/new/partner/15.jpg" alt="ТОО «Промотход Сервис»"> </a></figure>
            </li>
            <li class="item thumb web isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/15.jpg" alt="ТОО «ПромЭкоТехнология»"> </a></figure>
            </li>
            <li class="item thumb motion isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/8.jpg" alt="ТОО «Waste Logistic»"> </a></figure>
            </li>
            <li class="item thumb motion isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/15.jpg" alt="ТОО «Chemical Waste»"> </a></figure>
            </li>
            <li class="item thumb photo isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/15.jpg" alt="ТОО «Промотход Восток»"> </a></figure>
            </li>
            <li class="item thumb graphic isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/15.jpg" alt="ТОО «Промотход Development»"> </a></figure>
            </li>
            <li class="item thumb web isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/15.jpg" alt="ТОО «Утилизация LTD»"> </a></figure>
            </li>
            <li class="item thumb web isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
            ...
            <li class="item thumb web isotope-item">
              <figure><a href="#">
                ...
                <img src="/style/images/new/partner/13.jpg" alt="ТОО «Компания Артеко»"> </a></figure>
            </li>
            <li class="item thumb web isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/9.jpg" alt="ТОО «Утилизация LTD»"> </a></figure>
            </li>
            <li class="item thumb web isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
                ...
                <img src="/style/images/new/partner/10.jpg" alt="ТОО «Утилизация LTD»"> </a></figure>
            </li>
            <li class="item thumb web isotope-item">
              <figure><a href="#">
                <div class="text-overlay">
