    ...
    <div class="container inner text-center">
      <div class="testimonials">
        <div class="item">
          ...
          <blockquote><p>ECOMARKER YELIMAY – қауіпті қалдықтардың барлық түрлерін тиісінше кәдеге жарату жөніндегі кәсіпорынның адалдық белгісі.</p>
          <p>Жобаға қосылған компания жұмысшылардың өмірі мен денсаулығы үшін қауіпсіз және қолайлы аймақ құруға деген ниетін растайды.</p>
          <p>ECOMARKER YELIMAY қауіпсіз ортаны кеңейтуге күшті серпін береді.</p> 
          <p>ECOMARKER YELIMAY – біздің балаларымыз және немерелеріміз қаңдай елде тұратынына бей-жай қарамайтын барлық адамдар үшін белгі!</p>
          </blockquote>
          </div>
        </div>
      </div>
